...
enum L {
    ...
    enum Paywall {
        ...
        static let restoreSuccess = String(localized: "paywall.restore.success")
        static let productsUnavailable = String(localized: "paywall.products.unavailable")
        static let productsRetry = String(localized: "paywall.products.retry")
        static let planMonthly = String(localized: "paywall.plan.monthly")
        static let planYearly = String(localized: "paywall.plan.yearly")
        static let planLifetime = String(localized: "paywall.plan.lifetime")
        static let planMonthlyDescription = String(localized: "paywall.plan.monthly.description")
        static let planYearlyDescription = String(localized: "paywall.plan.yearly.description")
        static let planLifetimeDescription = String(localized: "paywall.plan.lifetime.description")
        static let planMonthlyPeriod = String(localized: "paywall.plan.monthly.period")
        static let planYearlyPeriod = String(localized: "paywall.plan.yearly.period")
        static let planLifetimePeriod = String(localized: "paywall.plan.lifetime.period")
        static let planYearlyBadge = String(localized: "paywall.plan.yearly.badge")
        static let planTrial = String(localized: "paywall.plan.trial")
        static let planIncludesPremium = String(localized: "paywall.plan.includes.premium")
        static let planMonthlyRenewal = String(localized: "paywall.plan.monthly.renewal")
        static let planYearlyRenewal = String(localized: "paywall.plan.yearly.renewal")
        static let planLifetimePurchase = String(localized: "paywall.plan.lifetime.purchase")
        static let legalNotice = String(localized: "paywall.legal.notice")
        static let legalTerms = String(localized: "paywall.legal.terms")
        static let legalPrivacy = String(localized: "paywall.legal.privacy")
        // Feature Comparison
        static let featureFree = String(localized: "paywall.feature.free")
        static let featurePremium = String(localized: "paywall.feature.premium")
        ...
        static let featureCaption = String(localized: "paywall.feature.caption")
    }

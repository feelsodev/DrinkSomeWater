...
### Definition of Done
- [x] HomeView에서 오늘 기록을 Instagram Stories/Feed로 공유 가능
- [x] HistoryView에서 선택한 날짜 기록을 Instagram Stories/Feed로 공유 가능
- [x] Instagram 미설치 시 알림 표시
- [x] 공유 카드에 섭취량, 목표량, 퍼센트, streak, 로고 표시
- [x] Stories (1080x1920), Feed (1080x1080) 이미지 생성
- [x] Analytics 이벤트 기록
- [x] 유닛 테스트 통과
...
### Final Checklist
- [x] HomeView에서 Instagram Stories/Feed로 오늘 기록 공유 가능
- [x] HistoryView에서 선택한 날짜 기록 공유 가능
- [x] 공유 카드에 섭취량, 목표량, 퍼센트, streak, 로고 표시
- [x] Stories (1080x1920), Feed (1080x1080) 이미지 정상 생성
- [x] Instagram 미설치 시 알림 표시
- [x] Analytics 이벤트 정상 기록
- [x] 모든 유닛 테스트 통과
- [x] Facebook App ID 설정 가이드 완성
